...
const AlbumSlider = () => {
  ...
  console.log(data);
  if (error) return "Failed to fech data";
    ...
    <>
      ...
      <Swiper
        ...
        breakpoints={{
          ...
          425: { slidesPerView: 2, spaceBetween: 80 },
          768: { slidesPerView: 3, spaceBetween: 80 },
          1024: { slidesPerView: 4, spaceBetween: 80 },
          1310: { slidesPerView: 5, spaceBetween: 80 },
        }}
        ...
        {data?.map((thumb, index) => {
          return (
            <SwiperSlide key={index} className="relative group overflow-hidden border-2 border-transparent w-[254px] rounded-[10px]">
              {/* img */}
              <div className="relative w-[195px] h-[195px] sm:w-[360px] md:w-[240px] cursor-pointer">
                <Image
                  src={thumb.img}
                  fill
                  priority
