...
const PostList = ({ posts }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col xl:flex-row justify-between gap-12 py-10 xl:pt-16 xl:pb-24 border-t border-main/10">
        {firstThreePosts.map(({ id, title, date, description }) => {
          return (
            <div key={id} className="flex-1">
              ...
              {/* description */}
              <p className="text-main/30 mb-6 font-light">{description}</p>
